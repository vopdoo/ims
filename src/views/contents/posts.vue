<template>
    <Card dis-hover :bordered="false" title="文章管理">
        ...
        <Table border :columns="columns" :data="post_list.data"></Table>
        <Row type="flex" style="margin-top: 10px;">
            <Col span="8">

            </Col>
            <Col span="16" class="list-tb-right">
            <Page :total="post_list.meta.total" @on-change="changePage" :current="1"></Page>
            </Col>
        </Row>
        ...
        >
            ...
            <Form :model="fmData" :label-width="100" ref="fm" :rules="fmRules">
                ...
                <FormItem label="推荐首页">
                    <i-switch size="large" v-model="fmData.is_recommended">
                ...
                <FormItem label="内容">
                    <froala :tag="'textarea'" :config="config" v-model="fmData.content"></froala>
                </FormItem>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.getLists();
            this.$store.dispatch('categoriesList', {with_posts:false,type:1});
        },
        computed: {
            ...mapGetters([
                'post_list',
        ...
        methods: {
            showAddModal() {
                ...
                this.fmData.is_recommended = false;
            ...
            getLists() {
                this.$store.dispatch('postList', this.searchForm);
            },
            search() {
                this.getLists();
            },
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {
                        title: '封面图', key: 'user', width: 120, render: (h, params) => {
                            return h('div', [
                                h('Avatar', {
                                    props: {
                    ...
                    },
                    {
                        ...
                        render:(h,params) => {
                            return h('Tag', {
                                props: {
                                    color: params.row.is_recommended ? 'success':'default'
                                }
                            }, params.row.is_recommended ? '是':'否');
                        }
                    },
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                h('Poptip', {
                                    ...
                                    on: {
                                        'on-ok': () => {
                                            this.$store.dispatch('delPost', {id: params.row.id}).then(rsp => {
                                                this.getLists();
                                            });
                                        }
                                    }
